...
class TemplateCompiler {
	 ...
	 * @param configuration
	 */
	public TemplateCompiler(def configuration) {
		config = configuration
	}
	
	/**
	 * Compiles the backbone templates.
	 */
	public void compile() {
	 ...
	 * @param map
	 */
	private void extractTemplatesFromDir (File baseFile, Map map) {
